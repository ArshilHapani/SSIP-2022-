...
let possibleInput = {
    ...
    "about": function () {
        responseText("This is me, GTU bot i'm here to help you!");
    ...
    "hii": function(){
        responseText("For better understanding between us, we need some information about you <br> Would you like to provide? ")
    },
...
var reactionInput = {
    ...
    "about": function () {
        responseText("Things I want to learn or do:");
        responseText("Provide the best guide to studend as much as I can");
        responseText("Create 3D browser experiences");
        responseText("Learn Three.js and WebGL");
        responseText("Combine Motion Design with Front-End");
        animationCounter = 1;
...
const ExamFee = ()=>{
    let link = "https://www.gtu.ac.in/page.aspx?p=Payment";
    let win = window.open(link)
}
const TimeTable = ()=>{
    let link = "https://timetable.gtu.ac.in/";
    let win = window.open(link)
}
const HallTicket = ()=>{
    let link = "https://student.gtu.ac.in/Login.aspx";
    let win = window.open(link)
}
const Admission = ()=>{
    let link = "https://gsms.gtu.ac.in/admission/";
    let win = window.open(link)
    // let arsh = document.querySelector('.chatbox')
    // createBubble(arsh);
}
const About = ()=>{
    let link = "https://www.old22.gtu.ac.in/page.aspx?p=AboutUs";
    let win = window.open(link)
}
const Result = ()=>{
