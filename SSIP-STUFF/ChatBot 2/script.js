...
let possibleInput = {
    ...
    "syllabus": function () {
        responseText("Type your Stream (Ex. 03 Diploma) <br><button class='syllabus' onclick='diplomaSelect()'>03 Diploma</button><button class='syllabus'>"+
        "01 Bachelor</button><button class='syllabus'>07 Master</button>")
        commandReset(3);
        return
    },
    "03 diploma": function () {
